  ...
  return (
    <div className="workspace-container">
      ...
      <main className="grid-container">
        ...
        <div className="card" onClick={() => switchTab('settings')}>
          <div className="card-icon" style={{ color: '#90a4ae' }}>
          ...
          <div className="card-content">
            <h2>Settings</h2>
            <p>Configure global preferences, set up auto-login profiles, and manage active telnet connections to the GrandMA2 system.</p>
          </div>
        </div>
      </main>
